					   ...
					   HICON icon, UINT uID)
{
	...
	//wcscpy_s(m_tnd.szTip, szToolTip);//ttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
...
BOOL CTrayIcon::SetTooltipText(LPCTSTR pszTip)
{
	...
	//wcscpy_s(m_tnd.szTip, pszTip);         //ttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
...
LRESULT CTrayIcon::OnTrayNotification(UINT wParam, LONG lParam) 
{
	...
	//if (LOWORD(lParam) == WM_RBUTTONCLK /*|| LOWORD(lParam) == WM_LBUTTONUP*/)
	if (LOWORD(lParam) == WM_RBUTTONDOWN /*|| LOWORD(lParam) == WM_LBUTTONUP*/)
	{	
		...
		TrackSkinPopupMenu(pSubMenu->m_hMenu, 0, pos.x, pos.y, m_tnd.hWnd );
