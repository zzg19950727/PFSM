...
#pragma pack(push, 8)
///////////////////////////////////////////////////////////////////////////
//Function: InitSkinMagicLib(HINSTANCE hInstance, LPCSTR szApplication , 
//					  LPCSTR szReserved1,
//					  LPCSTR szReserved2
//			
//Parameters: 
...
///////////////////////////////////////////////////////////////////////////
//Function: LoadSkinFile( LPCSTR SkinFile )
//			Load skin from file.
//Parameters: 
//		SkinFile 
...
//Remarks:
//		Load skin from file.	
int  __stdcall LoadSkinFile( LPCSTR lpSkinFile );

///////////////////////////////////////////////////////////////////////////
//Function: LoadSkinFromResource(HMODULE hModule, LPCSTR lpSkinName ,LPCSTR lpType)
...
int  __stdcall LoadSkinFromResource(HMODULE hModule, LPCSTR lpSkinName ,LPCSTR lpType);

///////////////////////////////////////////////////////////////////////////
//Function: SetWindowSkin( HWND hWnd , LPCSTR SkinName )
...
//          system/maximize/minimize/close buttons, caption and sizing edges
//          and corners.
int  __stdcall SetWindowSkin( HWND hWnd , LPCSTR lpSkinName );


///////////////////////////////////////////////////////////////////////////
//Function: SetShapeWindowSkin( HWND hWnd , LPCSTR SkinName )
...
//	 absolutely any shape or even be translucent.
//
int  __stdcall SetShapeWindowSkin( HWND hWnd , LPCSTR SkinName );
...
///////////////////////////////////////////////////////////////////////////
//Function: SetDialogSkin( LPCSTR szSkinName )
//			set skin of new create dialog
//			
//Parameters: 
//   szSkinName
...
//
int  __stdcall SetDialogSkin( LPCSTR szSkinName );

///////////////////////////////////////////////////////////////////////////
//Function: SetSingleDialogSkin( HWND hWnd ,LPCSTR szSkinName )
...
//
int  __stdcall SetSingleDialogSkin( HWND hWnd , LPCSTR szSkinName );
...
int __stdcall EnableCaptionButtons(HWND hWnd , LPCSTR lpName , BOOL bEnable );
...
HSKIN __stdcall OpenSkinData( LPCSTR pszSkinObjectName );
...
int __stdcall GetSkinFont( HSKIN hSkin,LPCSTR pszName , LOGFONT* pLogFont , COLORREF* pColor );
int __stdcall GetSkinColor( HSKIN hSkin , LPCSTR pszName, COLORREF* pColor );
int __stdcall GetSkinBool( HSKIN hSkin ,  LPCSTR pszName, bool* pbVal );
int __stdcall GetSkinInt( HSKIN hSkin ,  LPCSTR pszName, int* piVal );
int __stdcall GetSkinDWORD( HSKIN hSkin ,  LPCSTR pszName, DWORD* pdwVal );
int __stdcall GetSkinEnum( HSKIN hSkin ,  LPCSTR pszName, DWORD* pdwVal );
int __stdcall GetSkinString( HSKIN hSkin, LPCSTR pszName , LPTSTR pszBuff , unsigned long* pMaxBuffChars );
...
int __stdcall GetSkinImageSectionMargins( HSKIN hSkin, LPCSTR pszName , const RECT* pRect , const RECT* pMargins );   
...
///////////////////////////////////////////////////////////////////////////////////////////////
HIMAGELIST __stdcall CreateImageList( LPCSTR pszImageListObjectName );
...
int __stdcall RedrawCaptionStatic( HWND hWnd , LPCSTR lpName );
...
//   If the function fail, the return value is zero
///////////////////////////////////////////////////////////////////////////////////////////
int __stdcall GetCaptionButtonState(HWND hWnd , LPCSTR lpName , DWORD* pdwState );
...
//   If the function fail, the return value is zero
///////////////////////////////////////////////////////////////////////////////////////////
int __stdcall SetCaptionButtonState(HWND hWnd , LPCSTR lpName , DWORD dwState );
...
////////////////////////////////////////////////////////////////////////////////////////////
int __stdcall SetControlTooltip( HWND hWnd , LPCSTR lpTooltip );

int __stdcall SetCaptionButtonTooltip( HWND hWnd , LPCSTR lpName , LPCSTR lpTooltip );

int __stdcall ShowTooltipPoint( HWND hWnd , LPCSTR lpTooltip , LPPOINT lpPoint );

int __stdcall HideTooltip();


int __stdcall SetControlSkin( HWND hWnd , LPCSTR szSkinName, LPCSTR szOwnerSkinName  );
COLORREF __stdcall GetSkinSysColor( int nIndex );
HBRUSH __stdcall GetSkinSysColorBrush( int nIndex );

//
int __stdcall ShowSkinObject( HWND hWnd , LPCSTR szSkinObject , BOOL bVisible );

int __stdcall SetSkinObjectText( HWND hWnd , LPCSTR szSkinObject , LPCSTR lpText );

int __stdcall GetSkinObjectText( HWND hWnd , LPCSTR szSkinObject , LPTSTR  lpText , int nMaxCount );
...
HBITMAP __stdcall CreateBitmapFromSkinImage( LPCSTR szSkinImageName );
